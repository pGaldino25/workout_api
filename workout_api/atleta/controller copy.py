...
async def query(db_session: DatabaseDependency) -> list[AtletaOut]:
    ...
    if not atletas  :
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail="atleta não encontrada")
...
async def get(id: UUID4, db_session: DatabaseDependency) -> AtletaOut:
    ...
    if not atleta:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=f"Atleta não encontrado no id: {id}")
